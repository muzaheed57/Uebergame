...
ConnectData main( VertData IN,
                  ...
                  uniform float    oneOverTerrainSize : register(C20),
                  uniform float    squareSize      : register(C21),
                  ...
                  uniform float4   detailScaleAndFade2 : register(C19),
                  uniform float4x4 objTrans        : register(C8),
                  uniform float3   eyePosWorld     : register(C22),
