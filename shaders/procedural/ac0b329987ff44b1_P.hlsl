...
Fragout main( ConnectData IN,
              ...
              uniform float4    rtParams1       : register(C6),
              uniform sampler2D lightInfoBuffer : register(S1),
              uniform float4    subSurfaceParams : register(C2),
              uniform float4    specularColor   : register(C3),
              uniform float     specularPower   : register(C4),
              uniform float     visibility      : register(C5)
)
{
   Fragout OUT;
