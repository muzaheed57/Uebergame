...
Fragout main( ConnectData IN,
              ...
              uniform float4    inLightPos[3] : register(C3),
              uniform float4    inLightInvRadiusSq : register(C6),
              uniform float4    inLightColor[4] : register(C7),
              uniform float4    inLightSpotDir[3] : register(C11),
              uniform float4    inLightSpotAngle : register(C14),
              uniform float4    inLightSpotFalloff : register(C15),
              uniform float     specularPower   : register(C16),
              uniform float4    specularColor   : register(C17),
