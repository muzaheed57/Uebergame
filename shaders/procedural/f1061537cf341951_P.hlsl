...
Fragout main( ConnectData IN,
              ...
              uniform sampler2D detailMap2      : register(S6),
              uniform float4    rtParams0       : register(C4),
              uniform sampler2D lightInfoBuffer : register(S7)
)
{
   Fragout OUT;
   ...
   {
      detailColor = ( lerp( tex2D( detailMap0, IN.detCoord0.yz ), tex2D( detailMap0, IN.detCoord0.xz ), IN.texCoord.z ) * 2.0 ) - 1.0;
